...
export const FETCH_SINGLE_PRODUCT_BY_ID_START = 'FETCH_SINGLE_PRODUCT_BY_ID_START'
export const FETCH_SINGLE_PRODUCT_BY_ID_SUCCESS = 'FETCH_SINGLE_PRODUCT_BY_ID_SUCCESS'
export const FETCH_SINGLE_PRODUCT_BY_ID_FAILURE = 'FETCH_SINGLE_PRODUCT_BY_ID_FAILURE'
...
export const INCREMENT_PRODUCT_FROM_BASKET = 'INCREMENT_PRODUCT_FROM_BASKET'
